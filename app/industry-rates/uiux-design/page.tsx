...
export const metadata: Metadata = { title: 'UI/UX Designer Rates', description: 'Freelance UX/UI design rates by experience level.', alternates: { canonical: 'https://freelancepricecalculator.com/industry-rates/uiux-design' } }
